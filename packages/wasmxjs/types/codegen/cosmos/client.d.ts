...
export declare const cosmosAminoConverters: {
    ...
    "/cosmos.feegrant.v1beta1.MsgPruneAllowances": {
        aminoType: string;
        toAmino: ({ pruner }: import("./feegrant/v1beta1/tx").MsgPruneAllowances) => {
            pruner: string;
        };
        fromAmino: ({ pruner }: {
            pruner: string;
        }) => import("./feegrant/v1beta1/tx").MsgPruneAllowances;
    };
    ...
    "/cosmos.consensus.v1.MsgUpdateParams": {
        aminoType: string;
        toAmino: ({ authority, block, evidence, validator, abci }: import("./consensus/v1/tx").MsgUpdateParams) => {
            authority: string;
            block: {
                max_bytes: string;
                max_gas: string;
    ...
    "/cosmos.circuit.v1.MsgAuthorizeCircuitBreaker": {
        aminoType: string;
        toAmino: ({ granter, grantee, permissions }: import("./circuit/v1/tx").MsgAuthorizeCircuitBreaker) => {
            granter: string;
            grantee: string;
            permissions: {
                level: number;
        ...
        }) => import("./circuit/v1/tx").MsgAuthorizeCircuitBreaker;
    };
    "/cosmos.circuit.v1.MsgTripCircuitBreaker": {
        aminoType: string;
        toAmino: ({ authority, msgTypeUrls }: import("./circuit/v1/tx").MsgTripCircuitBreaker) => {
            authority: string;
        ...
        fromAmino: ({ authority, msg_type_urls }: {
            authority: string;
            msg_type_urls: string[];
        }) => import("./circuit/v1/tx").MsgTripCircuitBreaker;
    };
    "/cosmos.circuit.v1.MsgResetCircuitBreaker": {
        aminoType: string;
        toAmino: ({ authority, msgTypeUrls }: import("./circuit/v1/tx").MsgResetCircuitBreaker) => {
            authority: string;
            msg_type_urls: string[];
        };
        fromAmino: ({ authority, msg_type_urls }: {
            authority: string;
            msg_type_urls: string[];
        }) => import("./circuit/v1/tx").MsgResetCircuitBreaker;
    };
