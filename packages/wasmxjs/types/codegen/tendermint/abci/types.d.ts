...
import { BlockIDFlag, BlockIDFlagSDKType } from "../types/validator";
...
export declare enum ResponseVerifyVoteExtension_VerifyStatusSDKType {
    UNKNOWN = 0,
    ACCEPT = 1,
    /**
     * REJECT - Rejecting the vote extension will reject the entire precommit by the sender.
...
export interface ResponseVerifyVoteExtensionSDKType {
    status: ResponseVerifyVoteExtension_VerifyStatusSDKType;
}
