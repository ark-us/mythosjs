...
export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    mythos: {
        network: {
            v1: {
                contractCall(request: import("./network/v1/query").QueryContractCallRequest): Promise<import("./network/v1/query").QueryContractCallResponse>;
                queryMultiChain(request: import("./network/v1/query").QueryMultiChainRequest): Promise<import("./network/v1/query").QueryMultiChainResponse>;
            };
        };
        wasmx: {
            v1: {
                ...
                callEth(request: import(".").QueryCallEthRequest): Promise<import(".").QueryCallEthResponse>;
                debugContractCall(request: import(".").QueryDebugContractCallRequest): Promise<import(".").QueryDebugContractCallResponse>;
